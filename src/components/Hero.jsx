        ...
        <div className="hero-content">
          ...
          <div className="hero-text">
            ...
            <div className="hero-buttons" style={{display: 'flex', gap: '1rem'}}>
                <a href={`${import.meta.env.BASE_URL}#projects`} className="btn primary">Voir mes projets</a>
                <a href={`${import.meta.env.BASE_URL}#contact`} className="btn" style={{background: 'rgba(255,255,255,0.1)'}}>Me contacter</a>
            </div>
          </div>
        </div>
      </div>
